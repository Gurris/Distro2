namespace Distro2.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MessageModels", "toUser_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.MessageModels", "fromUser_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.MessageModels", new[] { "toUser_Id" });
            DropIndex("dbo.MessageModels", new[] { "fromUser_Id" });
